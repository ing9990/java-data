...
public class Main {
    public static void main(String[] args) {
        ...
        // 객체 배열 확인해서 걸러내기 (stream().filter(람다식 조건))
        ...
        // 나이로 정렬 ( stream().sorted(Comapartor.comparing(Class::GetMethod))
        ...
        System.out.println("\nstream max로 가장 나이가 많은 사람의 이름을 가져온다.");
